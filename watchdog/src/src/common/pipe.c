...
/*
 int
 tcreate_queue ( msg_t* msg_cmd ,  QLink * queue );
 int
 tadd_queue_head (  QLink * queue , msg_t* msg_cmd );
 int
 tadd_queue_tail (  QLink * queue , msg_t* msg_cmd);
 int
 tget_queue_head (  QLink * queue , msg_t* msg_get );
 int
 tget_queue_tail (  QLink * queue , msg_t* msg_get);
 int
 tdestory_queue ( QLink * queue);
 */
